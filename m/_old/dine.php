...
<div align="center" class="mndiv"><ul class="menu">
    ...
    <li>
    <a href="./?dine_with=1" <?php echo intval($_GET["dine_with"]) == 1?"class='se'":""; ?>>Dining with</a>
    </li>
    <li>
    <a href="./?dine_with=2"  <?php echo intval($_GET["dine_with"]) == 2?"class='se'":""; ?>>Dining with me</a>
    </li>
    <li>
    ...
    <div id="m_t_b">       <?php include_once("./actions/load.php"); ?>
    </div>
    <script>
		dine_(<?php echo intval($_GET["dine_with"]);?>)
	</script>